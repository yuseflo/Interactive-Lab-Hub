...
This PiClock demonstrates a competitive race between three different athletes. At the homescreen the user can either watch the marathon or adjust the settings. After that the time that the marathon lasts can be selected which is either 10 or 20 seconds. To make the marathon more exciting the speed change of the athletes is random, so nobody knows really who is going to win. In the end the winner of the marathon is displayed on the screen. 

https://drive.google.com/file/d/1kVcMqXtF2WbxqaR7WT3Ob2Sxb0lcNcDb/view?usp=sharing
